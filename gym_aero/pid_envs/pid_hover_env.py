from gym_aero.envs import hover_env
from gym_aero.pid_envs import pid_env_base
from math import sin, cos, acos
import gym
import numpy as np

class PIDHoverEnv(hover_env.HoverEnv, pid_env_base.PIDEnv):
    def __init__(self):
        super(PIDHoverEnv, self).__init__()
        self.name = "Hover-v0"
        
    def step(self, errors):
        xyz, zeta, uvw, pqr = super(PIDHoverEnv, self).pid_step(errors)
