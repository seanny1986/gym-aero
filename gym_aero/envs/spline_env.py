...
class SplineEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.observation_space = np.zeros((53,))
        self.bandwidth = 35.
    ...
    def reward(self, state, action):
        ...
        pos_rew = exp(-0.5*target_dist**2)*(2.-tanh(target_dist))
        ...
        att_rew = exp(-0.5*target_dist**2)*(2.-tanh(att_dist))
        dist_rew = 0.5*(self.dist_norm-dist_hat)
    ...
    def step(self, action):
        ...
        traj_next = traj_next_xyz.T.tolist()[0]
        
        next_state = next_state+current_rpm+goals+next_goals+traj_next+[self.time_state]
    ...
    def reset(self):
        ...
        state = state+current_rpm+goals+next_goals+traj_next+[self.time_state]      
        return state
    ...
    def generate_spline(self):
        ...
        t_data = np.linspace(0., 1., self.wp_horizon+1, endpoint=True)
