...
class TrajectoryEnvTwo(gym.Env):
    """
    ...
    def reset(self):
        ...
        state = state+current_rpm+goals+[self.time_state]      
        return state
    ...
    def generate_goal(self):
        ...
        y = np.random.uniform(low=-self.r_max, high=self.r_max)
        z = np.random.uniform(low=-self.r_max, high=self.r_max)
