...
class TrajectoryEnvTermThree(gym.Env):
    """
    ...
    def step(self, action, term):
        ...
        next_next_attitude_goal = (sin_zeta-self.goal_zeta_sin_next_next).T.tolist()[0]+(cos_zeta-self.goal_zeta_cos_next_next).T.tolist()[0]
