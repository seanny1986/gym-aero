...
class RandomWaypointEnvTerm(gym.Env):
    """
    ...
    def __init__(self):
        ...
        self.goal_zeta_sin = np.zeros((3,1))
        self.goal_zeta_cos = np.ones((3,1))
    ...
    def reward(self, state, action):
        ...
        time_rew = 0.
        return dist_rew, att_rew, vel_rew, ang_rew, ctrl_rew, cmplt_rew, time_rew
    ...
    def render(self, mode='human', close=False):
        ...
        self.ani.draw_label("Time: {0:.2f}".format(self.t*self.ctrl_dt), (self.ani.window.width // 2, 20.0))
        self.ani.draw()
