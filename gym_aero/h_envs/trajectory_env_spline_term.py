...
class TrajectoryEnvSplineTerm(gym.Env):
    """
    ...
    def step(self, action, term):
        ...
        next_state = next_state+current_rpm+goals+next_goals+traj_next+self.coeffs+[self.time_state]
    ...
    def reset(self):
        ...
        next_state = state+current_rpm+goals+next_goals+traj_next+self.coeffs+[self.time_state]
        return next_state
