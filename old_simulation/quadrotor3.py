import numpy as np
from math import sin, cos, acos, sqrt, atan2, asin, pi
#import wind
...
class Quadrotor:
    ...
    def __init__(self, params):
        ...
        print("Maximum Omega: \t\t\t{:.5f} rad/s".format(self.max_rpm))
        print("Hover Omega: \t\t\t{:.5f} rad/s".format(self.hov_rpm))
        print("Maximum RPM: \t\t\t{:.5f} rpm".format(self.max_rpm*30/pi))
        print("Hover RPM: \t\t\t{:.5f} rpm".format(self.hov_rpm*30/pi))
